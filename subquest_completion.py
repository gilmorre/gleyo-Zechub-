...
class SubquestCompletion(db.Model):
    ...
    # options: pending, success, failed, rejected

    # Admin review note (if rejected or manual check)
    review_note = db.Column(db.Text, nullable=True)
    attempts = db.Column(db.Integer, nullable=False, default=0)        # Total attempts
