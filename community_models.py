...
class CommunityWallet(db.Model):
    ...
    # Money fields (store in cents for safety)
    available_balance = db.Column(db.BigInteger, default=0)  # spendable
    locked_balance = db.Column(db.BigInteger, default=0)     # reserved
...
class CommunityWalletTransaction(db.Model):
    ...
    type = db.Column(db.String(50))  # deposit, lock, unlock, spend

    reference = db.Column(db.String(120))  # campaign id, payment id
