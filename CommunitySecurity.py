...
class CommunitySecurity(db.Model):
    ...
    # ✅ back_populates links back to Community.security_settings
    ...
    require_twitter_premium = db.Column(db.Boolean, default=False)
    require_aptos_address = db.Column(db.Boolean, default=False)
