...
from usertwitter import UserTwitter  # adjust if needed

logger = logging.getLogger(__name__)
twitter_bp = Blueprint("twitter", __name__)

# ─── Config ─────────────────────────────────────────────
CLIENT_ID     = os.getenv("TWITTER_CLIENT_ID", "QlRZQUttRjBXQUlZaUlkZFJSSWY6MTpjaQ")
CLIENT_SECRET = os.getenv("TWITTER_CLIENT_SECRET", "9u5jXskzwgaRa4pEAnjwpA2jZSulgVUNjqRwBOqDbWeqmXGA9S")
REDIRECT_URI  = os.getenv("TWITTER_REDIRECT_URI", "https://gleyo.app/twitter-callback")
